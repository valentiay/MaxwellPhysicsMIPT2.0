...
import experiment.physics.processors.AtomProcessor;

import java.util.ArrayList;
import java.util.List;

import static experiment.Boltzmann.gasTPF;
...
public class Physics {
    ...
    public Physics(List<Entity> atoms, AtomProcessor atomProcessor) {
    ...
    public Physics(List<Entity> atoms) {
        this.HEIGHT = Boltzmann.HEIGHT;
        this.WIDTH = Boltzmann.WIDTH;
        this.atoms = atoms;
        this.D = Boltzmann.D;
